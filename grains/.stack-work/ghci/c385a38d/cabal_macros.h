...
/* package grains-1.2.0.6 */
#ifndef VERSION_grains
#define VERSION_grains "1.2.0.6"
#endif /* VERSION_grains */
#ifndef MIN_VERSION_grains
#define MIN_VERSION_grains(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  2 || \
  (major1) == 1 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_grains */
...
#define CURRENT_PACKAGE_KEY "grains-1.2.0.6-JAECLxnS3rqEhLwhTM0Pgc"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "grains-1.2.0.6-JAECLxnS3rqEhLwhTM0Pgc"
