...
/* package hello-world-1.1.0.5 */
#ifndef VERSION_hello_world
#define VERSION_hello_world "1.1.0.5"
#endif /* VERSION_hello_world */
#ifndef MIN_VERSION_hello_world
#define MIN_VERSION_hello_world(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hello_world */
...
#define CURRENT_PACKAGE_KEY "hello-world-1.1.0.5-7faFfPcYQqhFVT23k8lVHR"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "hello-world-1.1.0.5-7faFfPcYQqhFVT23k8lVHR"
