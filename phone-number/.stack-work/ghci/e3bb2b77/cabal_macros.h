...
/* package phone-number-1.6.1.8 */
#ifndef VERSION_phone_number
#define VERSION_phone_number "1.6.1.8"
#endif /* VERSION_phone_number */
#ifndef MIN_VERSION_phone_number
#define MIN_VERSION_phone_number(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  6 || \
  (major1) == 1 && (major2) == 6 && (minor) <= 1)
#endif /* MIN_VERSION_phone_number */
...
#define CURRENT_PACKAGE_KEY "phone-number-1.6.1.8-9HYvK1UoPQEIe9CjVsSa2t"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "phone-number-1.6.1.8-9HYvK1UoPQEIe9CjVsSa2t"
