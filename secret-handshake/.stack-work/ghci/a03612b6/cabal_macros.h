...
/* package secret-handshake-1.2.0.6 */
#ifndef VERSION_secret_handshake
#define VERSION_secret_handshake "1.2.0.6"
#endif /* VERSION_secret_handshake */
#ifndef MIN_VERSION_secret_handshake
#define MIN_VERSION_secret_handshake(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  2 || \
  (major1) == 1 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_secret_handshake */
...
#define CURRENT_PACKAGE_KEY "secret-handshake-1.2.0.6-85PHjJs1PLq2RHC9O1dbb1"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "secret-handshake-1.2.0.6-85PHjJs1PLq2RHC9O1dbb1"
