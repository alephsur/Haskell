...
/* package twelve-days-1.2.0.5 */
#ifndef VERSION_twelve_days
#define VERSION_twelve_days "1.2.0.5"
#endif /* VERSION_twelve_days */
#ifndef MIN_VERSION_twelve_days
#define MIN_VERSION_twelve_days(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  2 || \
  (major1) == 1 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_twelve_days */
...
#define CURRENT_PACKAGE_KEY "twelve-days-1.2.0.5-DD5mmhlXgfv7miExMOimfZ"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "twelve-days-1.2.0.5-DD5mmhlXgfv7miExMOimfZ"
